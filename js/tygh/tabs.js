        ...
        function _checkSize(tabs_elm)
        {
            ...
            if (!sub_tab.length) {
                sub_tab = $('<li class="dropdown cm-subtabs subtab dropleft pull-right">' +
                    '<a class="dropdown-toggle" data-toggle="dropdown">' + _.tr('more') + '<b class="caret icon-down-dir"></b></a>' +
            ...
            $('.dropdown-toggle', sub_tab).html(_.tr('more') + '<b class="caret icon-down-dir"></b>');
            ...
            list.each(function(index) {
                ...
                if (is_sub) {
                    ...
                    if (self.hasClass('active')) {
                        ...
                        $(sub_tab).after(elem);
                        $('.dropdown-toggle', sub_tab).html('<b class="caret icon-down-dir"></b>');
                    }
                }
            });
