...
(function(_, $) {
    ...
    var methods = {
        init: function() {
            ...
            if (container.hasClass('cm-image-gallery-wrapper') || container.parent().hasClass('cm-image-gallery-wrapper')) {
        ...
        load: function(container, params) {
            if (scroller_type == 'owlcarousel') {
                container.owlCarousel({
                    ...
                    pagination: false,
                    navigation: true,
                    navigationText: params.items_count == 1 ? ['<i class="icon-left-circle"></i>', '<i class="icon-right-circle"></i>'] : ['<i class="icon-left-open-thin"></i>', '<i class="icon-right-open-thin"></i>'],
