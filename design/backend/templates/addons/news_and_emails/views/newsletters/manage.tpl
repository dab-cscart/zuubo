...
{capture name="adv_buttons"}
    {if $newsletter_type ==  $smarty.const.NEWSLETTER_TYPE_NEWSLETTER}
        {include file="common/tools.tpl" tool_href="newsletters.add?type=`$smarty.const.NEWSLETTER_TYPE_NEWSLETTER`" prefix="top" hide_tools="true" title=__("add_newsletter") icon=true}
    {elseif $newsletter_type ==  $smarty.const.NEWSLETTER_TYPE_TEMPLATE}
        {include file="common/tools.tpl" tool_href="newsletters.add?type=`$smarty.const.NEWSLETTER_TYPE_TEMPLATE`" prefix="top" hide_tools="true" title=__("add_template") icon=true}
    {elseif $newsletter_type ==  $smarty.const.NEWSLETTER_TYPE_AUTORESPONDER}
        {include file="common/tools.tpl" tool_href="newsletters.add?type=`$smarty.const.NEWSLETTER_TYPE_AUTORESPONDER`" prefix="top" hide_tools="true" title=__("add_autoresponder") icon=true}
    {/if}
{/capture}
