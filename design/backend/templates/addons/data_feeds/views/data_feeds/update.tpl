...
<div id="data_feed_export_settings" class="in collapse">
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="datafeed_data[save_dir]" id="elm_datafeed_save_directory" size="55" value="{$datafeed_data.save_dir|default:$config.dir.files}" class="input-text-large" />
        </div>
    </div>
</div>
