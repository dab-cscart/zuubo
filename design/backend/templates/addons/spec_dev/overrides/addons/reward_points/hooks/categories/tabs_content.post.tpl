<div class="hidden" id="content_reward_points">
    ...
    <div id="reward_points_categories_hook" class="in collapse">
	    ...
	    <div class="control-group">
                <label class="control-label" for="points_expiration_period">{__("points_expiration_period")}</label>
                <div class="controls">
                    <input type="text" id="points_expiration_period" name="category_data[points_expiration_period]" value="{$category_data.points_expiration_period}" size="10" >
                </div>
            </div>            <input type="hidden" name="category_data[is_op]" value="N">
