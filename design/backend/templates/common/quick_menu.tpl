...
<div class="quick-menu-container" id="quick_menu">
    <div class="quick-menu">
        <a id="sw_quick_menu_content"
           class="{if $edit_quick_menu || $expand_quick_menu}open{/if} cm-combination"{if $settings.show_menu_mouseover == "Y"} onmouseover="fn_quick_menu_mouse_action(this, true);" onmouseout="fn_quick_menu_mouse_action(this, false);"{/if}>{__("quick_menu")}</a>
    </div>
