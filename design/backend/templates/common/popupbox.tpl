...
{if !$content}
{$popup_params = "`$popup_params`  data-ca-dialog-title=\"`$text`\""}
{/if}
{if ($runtime.action && $runtime.action|fn_check_view_permissions:$method) || (!$runtime.action && $content|fn_check_view_permissions:$method)}
{if $act == "edit"}
