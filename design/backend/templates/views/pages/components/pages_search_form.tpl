...
<div class="sidebar-field">
    ...
    {if "pages"|fn_show_picker:$smarty.const.PAGE_THRESHOLD}
        {include file="pickers/pages/picker.tpl" data_id="location_page" input_name="parent_id" item_ids=$search.parent_id hide_link=true hide_delete_button=true show_root=true default_name=__("all_pages") extra="" no_container=true prepend=true}
    {else}
