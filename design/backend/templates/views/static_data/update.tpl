            ...
            <div class="control-group">
                ...
                <div class="controls mixed-controls">
                    ...
                    {elseif $p.type == "megabox"}
                        ...
                        <div class="form-inline clearfix cm-block-switch">
                            <label for="rb_{$id}" class="radio pull-left">
                                <input type="radio" class="cm-block-on" name="static_data[megabox][type][{$p.name}]" id="rb_{$id}" {if !$_megabox_values}checked="checked"{/if} value="" onclick="Tygh.$('#un_{$id}').prop('disabled', true);">
                                {__("none")}
                            </label>
                        </div>
                        ...
                        <div class="form-inline clearfix cm-block-switch">
                            <label for="rb_c_{$id}" class="radio pull-left">
                                    <input type="radio" class="cm-block-on" name="static_data[megabox][type][{$p.name}]" id="rb_c_{$id}" {if $_megabox_values.types.C}checked="checked"{/if} value="C" onclick="Tygh.$('#un_{$id}').prop('disabled', false);">
                                    {__("category")}:
                            </label>
                            <div id="megabox_container_c_{$id}" class="pull-left disable-overlay-wrap">
                                {include file="pickers/categories/picker.tpl" data_id="megabox_category_`$id`" input_name="static_data[`$p.name`][C]" item_ids=$_megabox_values.types.C.value hide_link=true hide_delete_button=true show_root=true default_name=__("all_categories") extra=""}
                                <div class="disable-overlay cm-block-off"></div>
                            </div>
                        </div>
                
                        <div class="form-inline clearfix cm-block-switch">
                            <label for="rb_a_{$id}" class="radio pull-left">
                                <input type="radio" class="cm-block-on" name="static_data[megabox][type][{$p.name}]" id="rb_a_{$id}" {if $_megabox_values.types.A}checked="checked"{/if} value="A" onclick="Tygh.$('#un_{$id}').prop('disabled', false);">
                                {__("page")}:
                            </label>
                            <div id="megabox_container_a_{$id}" class="pull-left disable-overlay-wrap">
                                {include file="pickers/pages/picker.tpl" data_id="megabox_page_`$id`" input_name="static_data[`$p.name`][A]" item_ids=$_megabox_values.types.A.value hide_link=true hide_delete_button=true show_root=true default_name=__("all_pages") extra="" no_container=true prepend=true}
                                <div class="disable-overlay cm-block-off"></div>
                            </div>
                        </div>
                        <br>
