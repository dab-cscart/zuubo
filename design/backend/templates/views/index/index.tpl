        ...
        <div class="welcome-screen">
            ...
            <div class="welcome-location-wrapper clearfix">
                <div class="welcome-location-block pull-left center">
                    ...
                    <a class="cm-dialog-opener cm-ajax btn btn-primary strong" data-ca-target-id="content_settings_wizard" title="{__("settings_wizard")}" href="{"settings_wizard.view?return_url=`$config.current_url`"|fn_url}" target="_blank">{__("welcome_screen.run_settings_wizard")}</a>
                </div>
                <div class="welcome-location-block pull-right center">
                    ...
                    <a class="kbase-link" href="http://kb.cs-cart.com/installation" target="_blank">{__("welcome_screen.knowledge_base")}</a>
                </div>
            </div>
            <div class="welcome-screen-social center">
                <p>
                    {__("welcome_screen.thanks")}
                </p>
