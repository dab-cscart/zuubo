...
<div id="content_general">
    ...
    <div id="themes_manage" class="themes-current clearfix">
        ...
        <div class="span8 theme-description" id="theme_description_container">
            <h4>{$theme.title}{if $layout.style_name}: {$layout.style_name}{/if}</h4>
    ...
    {foreach $available_themes.installed as $theme_name => $installed_theme}
        ...
        <div class="row">
            <div class="theme-subtitle">
                <a class="cm-confirm cm-tooltip btn pull-right btn-small" href="{"themes.delete?theme_name=`$theme_name`"|fn_url}" title="{__("remove")}"> <i class="icon-trash"></i> </a>
            ...
            {if $installed_theme@iteration is div by 3}
                ...
                <div class="theme">
                    ...
                    <div class="theme-actions">
                        {capture name="tools_list"}
                            ...
                            {if $repo_theme.screenshot}
                            <li><a id="image_img_{$theme_name}" href="{$repo_theme.screenshot}" data-ca-image-id="img_{$theme_name}" class="cm-previewer">{__("preview")}</a></li>
                            {/if}
    ...
    <div class="container themes-side">
        ...
        <div class="sidebar-row clearfix">
            ...
            <div class="row-fluid">
                ...
                <div class="span5 right"><a class="pull-right" href="{"template_editor.manage"|fn_url}">/{$settings.theme_name}</a></div>
            </div>
            <div class="row-fluid">
