...
{capture name="sidebar"}
    {if $allow_save && !$runtime.company_id}
...
{/if}
{include file="common/mainbox.tpl" title=$title content=$smarty.capture.mainbox sidebar=$smarty.capture.sidebar buttons=$smarty.capture.buttons select_languages=true}
