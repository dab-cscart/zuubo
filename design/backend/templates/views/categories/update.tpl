...
<div id="content_detailed">
    ...
    <div class="control-group">
        {if "categories"|fn_show_picker:$smarty.const.CATEGORY_THRESHOLD}
            ...
            <div class="controls">
                {include file="pickers/categories/picker.tpl" data_id="location_category" input_name="category_data[parent_id]" item_ids=$category_data.parent_id|default:"0" hide_link=true hide_delete_button=true show_root=true default_name=__("root_level") display_input_id="elm_category_parent_id" except_id=$id}
            </div>
        {else}
...
<div id="content_layout">
    <div id="extra">
        <div class="control-group">
            <label class="control-label" for="elm_category_product_layout">{__("product_details_layout")}:</label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label" for="elm_category_use_custom_templates">{__("use_custom_layout")}:</label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label">{__("available_layouts")}:</label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label" for="elm_category_default_layout">{__("default_category_layout")}:</label>
            <div class="controls">
    ...
    {if $id}
        ...
        {capture name="tools_list"}
            {hook name="categories:update_tools_list"}
                ...
                <li>{btn type="list" class="cm-confirm" text=__("delete_this_category") href="categories.delete?category_id=`$id`"}</li>
            {/hook}
        {/capture}
...
{if !$id}
    {include file="common/mainbox.tpl" title=__("new_category") sidebar=$smarty.capture.sidebar content=$smarty.capture.mainbox buttons=$smarty.capture.buttons}
{else}
    {include file="common/mainbox.tpl" sidebar=$smarty.capture.sidebar title="{__("editing_category")}: `$category_data.category`" content=$smarty.capture.mainbox select_languages=true buttons=$smarty.capture.buttons adv_buttons=$smarty.capture.adv_buttons}
{/if}
