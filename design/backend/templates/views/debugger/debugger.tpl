...
<div id="DebugToolbar">
    ...
    <div class="deb-panel">
        ...
        {if $smarty.const.DEBUG_MODE !== true}
            {$current_url = $config.current_url|fn_query_remove:"debug"}
        ...
        <ul class="deb-resource-usage">
            ...
            {elseif "MULTIVENDOR"|fn_allowed_for}
                <li>Debug on <a href="{"?debug=`$debugger_id`"|fn_url:'C'}" target="_blank" >storefront</a></li>
            {else}
                <li>Debug on <a href="{"?debug=`$debugger_id`&company_id=`$runtime.company_id`"|fn_url:'C'}" target="_blank" >storefront</a></li>
            {/if}
        </ul>
        </div>
    </div>
