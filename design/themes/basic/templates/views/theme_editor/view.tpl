...
<input type="hidden" name="style_id" value="{$current_style.style_id}" data-ca-is-default="{$manifest.default[$current_style.style_id]}">
    ...
    <div class="te-header{if !$props_schema} te-header-no-schema{/if}" id="te_styles_list">
        ...
        <div class="te-header-menu-wrap">
            <div class="te-header-menu-wrap-left">
                {$current_style_name = $manifest.names[$current_style.name]|default:$current_style.name}
                ...
                <ul class="te-select-dropdown" id="elm_te_styles">
                    {foreach from=$styles_list item="s_item"}
                        <li class="{if $runtime.layout.style_id === $s_item.style_id}active{/if}">
                            <a class="cm-te-load-style {if $runtime.layout.style_id === $s_item.style_id}active{/if}" data-ca-target-id="theme_editor" href="{"theme_editor.view?style_id=`$s_item.style_id`"|fn_url}" data-ca-style-id="{$s_item.style_id}">{$manifest.names[$s_item.name]|default:$s_item.name}</a>
