...
<h1 class="mainbox-title"><span>{__("register_to_sell")}</span></h1>
...
*}
<div class="control-group">
    <label for="company_description_company" class="cm-required">{__("business_or_store_name")}</label>
...
<div class="control-group">
    <label for="company_description_email" class="cm-required cm-email cm-trim">{__("email_address")}</label>
    <input type="text" name="company_data[email]" id="company_description_email" size="32" value="{$company_data.email}" class="input-text" />
</div>

<div class="control-group">
    <label for="company_description_phone" class="cm-required">{__("phone_number")}</label>
...
<div class="buttons-container">
    {include file="buttons/button.tpl" but_text=__("register_to_sell") but_name="dispatch[companies.apply_for_vendor]" but_id="but_apply_for_vendor"}
</div>
