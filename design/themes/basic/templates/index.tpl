...
<div class="tygh {if $runtime.customization_mode.theme_editor}te-mode{/if} {if $runtime.customization_mode.translation || $runtime.customization_mode.design}top-panel-padding{/if}" id="tygh_container">
