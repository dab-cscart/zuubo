...
<tr>
    ...
    <th style="width: 55%">{__("reason")}</th>
...
<tr {cycle values=",class=\"table-row\""}>
    ...
    <td class="valign-top">{if $ul.expiration_date}{$ul.expiration_date|date_format:"`$settings.Appearance.date_format`, `$settings.Appearance.time_format`"}{else}-{/if}</td>
</tr>
{foreachelse}
<tr>
