<?php /* Smarty version Smarty-3.1.15, created on 2014-03-06 21:02:53
         compiled from "/var/www/html/zuubo/design/backend/templates/common/scripts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1529973775318aa3d7bf085-30981039%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51a7b3d0710fe36e5380b2c426500d5f6189146e' => 
    array (
      0 => '/var/www/html/zuubo/design/backend/templates/common/scripts.tpl',
      1 => 1390826990,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1529973775318aa3d7bf085-30981039',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5318aa3da4a5d7_48714140',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5318aa3da4a5d7_48714140')) {function content_5318aa3da4a5d7_48714140($_smarty_tpl) {?><?php if (!is_callable('smarty_block_scripts')) include '/var/www/html/zuubo/app/functions/smarty_plugins/block.scripts.php';
if (!is_callable('smarty_function_script')) include '/var/www/html/zuubo/app/functions/smarty_plugins/function.script.php';
if (!is_callable('smarty_block_hook')) include '/var/www/html/zuubo/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('text_forbidden_functionality','cannot_buy','no_products_selected','error_no_items_selected','delete_confirmation','text_out_of_stock','items','text_required_group_product','save','close','loading','notice','warning','error','text_are_you_sure_to_proceed','text_invalid_url','error_validator_email','error_validator_phone','error_validator_integer','error_validator_multiple','error_validator_password','error_validator_required','error_validator_zipcode','error_validator_message','error_validator_color','text_page_loading','error_ajax','text_changes_not_saved','text_data_changed','text_block_trial_notice','text_expired_license','file_browser','editing_block','editing_grid','editing_container','adding_grid','adding_block_to_grid','manage_blocks','editing_block','add_block','text_position_updating','more','text_full_mode_required','browse','enter_new_lang_code','no_image'));
?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("promo_data", null, null); ob_start(); ?>
    <div class="commercial-promotion-text">
        <p><?php echo $_smarty_tpl->__("text_forbidden_functionality");?>
</p>
    <div>
...
',
        text_full_mode_required: '<?php echo strtr($_smarty_tpl->__("text_full_mode_required"), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/" ));?>
',
...
', // CSRF form protection key
        <?php }?>
        promo_data: '<?php echo strtr(Smarty::$_smarty_vars['capture']['promo_data'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/" ));?>
'
    });
