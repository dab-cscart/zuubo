        ...
        <div class="chain-content clearfix">
                ...
                <div class="chain-product">
                    ...
                    {if $chain.product_options}
                        {capture name="buy_together_product_options"}
                            <div id="buy_together_options_{$chain.chain_id}_{$key}" class="chain-product-options{if $settings.Appearance.default_product_details_layout != "default_template"} long{/if}">
            ...
            {foreach from=$chain.products key="_id" item="_product"}
                ...
                <div class="chain-product">
                    ...
                    {elseif $_product.aoc}
                        {capture name="buy_together_product_options"}
                            <div id="buy_together_options_{$chain.chain_id}_{$_product.product_id}" class="chain-product-options{if $settings.Appearance.default_product_details_layout != "default_template"} long{/if}">
