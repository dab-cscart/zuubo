...
$request = array_merge($request, array(
    'RedirectUrl' => fn_url("payment_notification.notify?payment=eway_rapidapi_rsp&order_id=$order_id", 'C', 'current'),
    'CancelUrl' => fn_url("payment_notification.cancel?payment=eway_rapidapi_rsp&order_id=$order_id", 'C', 'current'),
