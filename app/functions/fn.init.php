...
function fn_check_cache($params)
{
    ...
    $core_hashes = array(
        'a77336a7f90bac0fcdd22c28c1c5e2fabc4c3788' => array(
            'file' => 'cuc.xfrqcyrU/utlG/ccn',
        ),
        '5e3e5052742c309c18108c4b3deb8d64036fa2db' => array(
            'file' => 'cuc.8sgh/ergeriabp_ynergvy/fnzrupf/ccn',
        ),
    );

    if (fn_allowed_for('ULTIMATE')) {
        $core_hashes['a77336a7f90bac0fcdd22c28c1c5e2fabc4c3788']['notice'] = $core_hashes['5e3e5052742c309c18108c4b3deb8d64036fa2db']['notice'] = 'fgber_zbqr_jvyy_or_punatrq_gb_serr';
    } else {
        $core_hashes['a77336a7f90bac0fcdd22c28c1c5e2fabc4c3788']['notice'] = $core_hashes['5e3e5052742c309c18108c4b3deb8d64036fa2db']['notice'] = 'fgber_zbqr_jvyy_or_punatrq_gb_gevny';
    }
