...
ALTER TABLE `?:shippings` DROP `params`;
ALTER TABLE `?:shippings` ADD `service_params` text NOT NULL;
...
DELETE FROM ?:static_data, ?:static_data_descriptions USING ?:static_data LEFT JOIN ?:static_data_descriptions ON ?:static_data.param_id = ?:static_data_descriptions.param_id WHERE ?:static_data.section = 'C';
