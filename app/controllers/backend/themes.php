...
if ($mode == 'install') {
    ...
    $manifest = Styles::factory($theme_name)->getManifest();

    if (!empty($manifest['names'][$layout['style_id']])) {
        $layout['style_name'] = $manifest['names'][$layout['style_id']];
    } else {
