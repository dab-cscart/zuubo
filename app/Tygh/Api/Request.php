...
class Request
{
     ...
     */
    private function getResourceNameFromRequest()
    {
     ...
     */
    private function getHeadersFromRequestHeaders()
    {
        return array(
    ...
    private function getContentTypeFromHeader($header_content_type)
    {
        $content_type = '';
    ...
    private function getAcceptTypeFromHeader($header_accept)
    {
        $accept_type = '';
     ...
     */
    private function getAvailableContentType($mime_types)
    {
     ...
     */
    private function parseHeaderAccept($header)
    {
        if (!$header) {
            return array();
        }
     ...
     * @return string Content type
     */
    private function getDataFromRequestBody()
    {
        $params = array();
